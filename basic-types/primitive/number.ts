let myNumber:number = 123456; // number 
let myHexadecimal: number = 0x37CF;  // hexadecimal
let myOctal:number=0o377 ;      // octal
let myBinary: number = 0b111001;// binary

// temel number fonksiyonlari

// number function toExponential
...
// number function toLocaleString
myNumber= 10667.987;
